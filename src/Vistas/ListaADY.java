 ...
 */
public class ListaADY extends javax.swing.JFrame {
    /**
    ...
    public ListaADY(int i,Grafos grafos,int lista,Frame frame ) {
        this.i=i;
        this.grafo=grafos;
        this.frame = frame;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Lista de Adyacencia"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaADY.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
