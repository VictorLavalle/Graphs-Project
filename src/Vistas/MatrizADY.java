 ...
 */
public class MatrizADY extends javax.swing.JFrame {
    /**
    ...
    public MatrizADY(int i,Grafos grafos,int matriz,Frame frame ) {
        this.i=i;
        this.grafo=grafos;
        this.frame = frame;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MatrizADY.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
