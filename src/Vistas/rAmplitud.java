 ...
 */
public class rAmplitud extends javax.swing.JFrame {
    /**
    ...
    public rAmplitud(int i,Grafos grafos,int lista,Frame frame ) {
        this.i=i;
        this.grafo=grafos;
        this.frame = frame;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rAmplitud.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
